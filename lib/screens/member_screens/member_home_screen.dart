...
import 'package:gym/screens/member_screens/qr_scanner_screen.dart';
import 'package:gym/utils/constants.dart';
import 'package:gym/widgets/empty_content.dart';
import 'package:gym/widgets/member_widgets/member_list_card.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          Expanded(
            ...
            child: GestureDetector(
              onTap: () => AllBookingsScreen.show(context,
                  ...
                  identifier: 'member'), //pass identifier owner or member
              child: Container(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => QrScannerScreen.show(context),
